...
class UnitTestSessionLogin(unittest.TestCase):
    '''
    用户会话登录(tecs.session.login)
    '''  
...
class UnitTestSessionLogout(unittest.TestCase):
    '''
    用户会话登出(tecs.session.logout)
    '''  
    def __init__(self, environment):
        self.environment = environment
        self.config_para = self.environment.config_para
...
class UnitTestSessionQuery(unittest.TestCase):
    '''
    用户会话查询(tecs.session.query)
    '''  
    def __init__(self, environment):
        self.environment = environment
        self.config_para = self.environment.config_para
...
def all_test_entry(environment):
    UnitTestSessionLogin(environment).test_entery()
    UnitTestSessionLogout(environment).test_entery()
    UnitTestSessionQuery(environment).test_entery()
...
def all_doc_entry(cidoc):
    ...
    module_name = "用户登录RPC"
    cidoc.write_doc(UnitTestSessionLogin, module_name)
    cidoc.write_doc(UnitTestSessionLogout, module_name)
    cidoc.write_doc(UnitTestSessionQuery, module_name)
