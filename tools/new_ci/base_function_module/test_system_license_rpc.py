...
# 测试接口封装
#from interface.base_interface.rpc import license

class UnitTestLicenseQuery(unittest.TestCase):
    '''
    查询系统许可证信息(tecs.system.license.query)
    '''  
...
def all_test_entry(environment):
    UnitTestLicenseQuery(environment).test_entery()
...
def all_doc_entry(cidoc):
    ...
    module_name = "系统license RPC"
    cidoc.write_doc(UnitTestLicenseQuery, module_name)
