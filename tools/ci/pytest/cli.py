...
from tecs.trunk import *
from tecs.port import *
from tecs.vnet_vlan import *
...
class TecsShell(cmd.Cmd):    
    def do_login(self,s):
        ...
        global server_addr
        global server_port
        server_url = '%s%s%s%s%s%s%s%s%s' % ('http://',username,':',password,'@',server_addr,':',server_port,'/RPC2')
    ...
    def do_runtime_query(self,s):
        ...
        s = tecssystem(self.server,self.session)
    ...
    def do_clustercfg_delete(self,s):
        ...
        clustercfg = clustercfg(self.server,self.session)
    ...
    def do_clustercfg_query(self,s):
        ...
        ccfg = clustercfg(self.server,self.session)
    ...
    def do_regcc(self,s):
        ...
        cm = clustermanager(self.server,self.session)
    ...
    def do_reghc(self,s):
        ...
        h = host(self.server,self.session)
    ...
    def do_set_svcpu(self,s):
        ...
        sv = svcpu(self.server,self.session)
    ...
    def do_create_usergroup(self,s):
        ...
        ug = usergroup(self.server,self.session)
    ...
    def do_create_user(self,s):
        ...
        u = user(self.server,self.session)
    ...
    def do_get_image_id(self,s):
        ...
        if len(args)!=1:
            ...
            return
        image_name=args[0]
        i = image(self.server,self.session)
    ...
    def do_enable_image(self,s):
        ...
        im = image(self.server,self.session)
    ...
    def do_create_project(self,s):     
        ...
        if len(args)!=1:
            ...
            return
        projectname=args[0]
        p = project(self.server,self.session)
    ...
    def do_delete_port(self,s):
        ...
        p = port(self.server,self.session)
    ...
    def do_delete_trunk(self,s):
        ...
        t = trunk(self.server,self.session)
    ...
    def do_delete_netplane(self,s):
        ...
        np = netplane(self.server,self.session)
    ...
    def do_delete_netplane_map(self,s):
        ...
        nmp = netplane_map(self.server,self.session)
    ...
    def do_query_vlan(self,s):
        ...
        vn = vlan(self.server,self.session)
    ...
    def do_create_vmtpl(self,s):
        ...
        cfg["is_public"] =  True
        v = vmtcfg(self.server,self.session)
    ...
    def do_create_vm(self,s):
        ...
        cfg["vm_num"] = 1
        v = vmcfg(self.server,self.session)
        if v.allocate(cfg) != True:
            ci_exit(-1)
