...
* 
* 文件名称：libvirt_driver.h
* 文件标识：
* 内容摘要：libvirtDriver类的定义文件
* 当前版本：1.0
* 作    者：lixch
* 完成日期：2013年3月25日
*
...
#ifndef HC_LIBVIRTDRIVER_H
#define HC_LIBVIRTDRIVER_H
 ...
 *                    虚拟化驱动                                                    *
 ***********************************************************************************/
class LibvirtDriver:public VmDriverBase
{
