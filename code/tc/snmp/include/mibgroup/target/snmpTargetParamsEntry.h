 ...
 */
     ...
     struct targetParamTable_struct *get_aPTable(void);
     struct targetParamTable_struct *get_paraForName(char *name);
     void   snmpTargetParamTable_remove(struct targetParamTable_struct *oldEntry);
/*
