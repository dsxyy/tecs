...
/* Define to 1 if you have the <getoptt.h> header file. */
#define HAVE_GETOPTT_H 1

/* Define to 1 if you have the `getpagesize' function. */
#define HAVE_GETPAGESIZE 1

/* Define to 1 if you have the `getpid' function. */
/* #define HAVE_GETPID 1  anzhiqi */
...
/* #define HAVE_SETLOCALE 1 anzhiqi */
...
#define NETSNMP_DEFAULT_MIBS ":IP-MIB:IF-MIB:TCP-MIB:UDP-MIB:HOST-RESOURCES-MIB:SNMPv2-MIB:RFC1213-MIB:NOTIFICATION-LOG-MIB:DISMAN-EVENT-MIB:DISMAN-SCHEDULE-MIB:UCD-SNMP-MIB:UCD-DEMO-MIB:SNMP-TARGET-MIB:NET-SNMP-AGENT-MIB:HOST-RESOURCES-TYPES:SNMP-FRAMEWORK-MIB:SNMP-MPD-MIB:SNMP-USER-BASED-SM-MIB:SNMP-VIEW-BASED-ACM-MIB:SNMP-COMMUNITY-MIB:IP-FORWARD-MIB:NET-SNMP-EXTEND-MIB:UCD-DLMOD-MIB:SNMP-NOTIFICATION-MIB:SNMPv2-TM:NET-SNMP-VACM-MIB:ZTE-ATCACMM-MIB:ZTE-ATCACMMALARM-MIB"

/* default location to look for mibs to load using the above tokens
   and/or those in the MIBS envrionment variable*/
#define NETSNMP_DEFAULT_MIBDIRS "/FLASH0/snmp/mibs"
...
#define NETSNMP_PERSISTENT_DIRECTORY "/FLASH0/persistent"
...
#define NETSNMP_AGENT_DIRECTORY_MODE 0777
...
#define SNMPCONFPATH "/FLASH0/snmp/conf"
...
#define NETSNMP_LOGFILE "/FLASH0/snmp/log/snmpd.log"
...
/*#define NETSNMP_ERRORTIMELENGTH 600  anzhiqi */
...
/*#define NETSNMP_EMBEDDED_PERL 1  anzhiqi */
...
/* #define UCD_SNMP_LIBRARY 1  anzhiqi */
...
/* define string-type oid length */
#define STRING_OID_MAXLEN     50
