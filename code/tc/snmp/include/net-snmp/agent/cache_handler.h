...
#define CACHE_NAME "cache_info"
    ...
    typedef int (NetsnmpCacheCommit)(netsnmp_cache *, void*);
	 ...
	 */
        ...
        NetsnmpCacheCommit *commit_cache;
    ...
    netsnmp_mib_handler *netsnmp_get_cache_handler(int, NetsnmpCacheLoad *,
                                                        NetsnmpCacheFree *, NetsnmpCacheCommit *,
                                                        oid*, int);
    ...
    void    _cache_free( netsnmp_cache *cache );
