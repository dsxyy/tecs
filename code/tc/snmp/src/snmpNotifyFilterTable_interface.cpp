...
{
    snmpNotifyFilterTable_rowreq_ctx *rowreq_ctx =
        (snmpNotifyFilterTable_rowreq_ctx *)netsnmp_container_table_row_extract(requests);
    int             rc, packet_rc;
                                            ...
                                            * mib_idx)
{
    ...
    rowreq_ctx =
        (snmpNotifyFilterTable_rowreq_ctx *)CONTAINER_FIND(snmpNotifyFilterTable_if_ctx.container, &oid_idx);
