...
Requires: lm_sensors ntpdate
Prefix: %{_prefix}
%description
Host Controller is used to manage single physical host in TECS. 
...
%{_prefix}/hc/bin/host_info.sh
%{_prefix}/hc/bin/host_pci.sh
%{_prefix}/hc/bin/host_report.sh
%{_prefix}/hc/bin/port_info.sh
%{_prefix}/hc/bin/host_handle.sh
%{_prefix}/hc/bin/killvm.sh
