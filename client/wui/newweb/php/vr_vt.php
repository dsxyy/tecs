<?php
    ...
    $filed = array("vt_name","vcpu","tcu","memory","total_size",$is_public_type,"user_name");
    $orderfield = "";
    $orderdir = "";
    $order = "";
    ...
    $totalnumrs->Close();
    //查表数据
    $query = ' SELECT vt_name,vcpu,tcu,memory,total_size, ' . $is_public_type . ',user_name ';
