<?php
    ...
    $filed = array("image_id","file_name","register_time",$enabled_type,"running_vms","type","size");
    $orderfield = "";
    $orderdir = "";
    $order = "";
    ...
    $totalnumrs->Close();
    //查表数据
    $query = ' SELECT image_id,file_name,register_time,' . $enabled_type . ',running_vms,type,size ';
