<?php
    ...
    $iTotalRecords = 0;
    $filed         = array("request_id","name","size","description");
    $orderfield    = "";
    $orderdir      = "";
    $order         = "";
    ...
    $filter = " 1=1 and username = '" . $user_name . "'";       
    if($sSearch != ""){
        $filter = $filter . " and ( ";
    ...
    //查询表数据
    $query = 'select p.request_id, p.name, p.size, p.sid, p.description,';
