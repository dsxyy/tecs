            ...
            for(var i=0;i<node.childNodes.length;i++){
                ...
                if (child.nodeType == 1){
                    switch (child.tagName){
                        ...
                        case "i8":
                            return (child.firstChild) ? new I8(child.firstChild.nodeValue) : 0;
                        case "boolean":
...
I8.prototype.toString = function(){
    ...
    I8.prototype.toXmlRpc= function(){
    	if(this.val == parseInt(this.val)){
            return "<i8>" + this.val + "</i8>";
        }/*else if(this == parseFloat(this)){
            return "<double>" + this + "</double>";
        }else{
            return false.toXmlRpc();
...
function I4(value){
  this.val = value;
    ...
    I4.prototype.toXmlRpc= function(){
    	if(this.val == parseInt(this.val)){
            return "<i4>" + this.val + "</i4>";
        }/*else if(this == parseFloat(this)){
            return "<double>" + this + "</double>";
        }else{
            return false.toXmlRpc();
    ...
    Date.prototype.toString = function(){
        ...
        var y = padd(this.getFullYear(), "0000");
        var m = padd(this.getMonth() + 1, "00");
        var d = padd(this.getDate(), "00");
        var h = padd(this.getHours(), "00");
        var min = padd(this.getMinutes(), "00");
        var s = padd(this.getSeconds(), "00");
        
        var isodate = y + "-" + m + "-" + d + " " + h +  ":" + min + ":" + s;
